...
typedef struct b2Circle { b2Vec2 point; float radius; } b2Circle;
typedef struct b2Capsule { b2Vec2 point1; b2Vec2 point2; float radius; } b2Capsule;
typedef struct b2Segment { b2Vec2 point1; b2Vec2 point2; } b2Segment;
typedef struct b2Polygon { b2Vec2 vertices[8]; b2Vec2 normals[8]; int count; float radius; } b2Polygon;

// Now defined as a real struct for function return values
...
typedef struct b2WorldDef
{
	...
	typedef float (*b2FrictionCallback)( float frictionA, int typeA, float frictionB, int typeB );

	/// Optional mixing callback for restitution. The default uses max(restitutionA, restitutionB).
	typedef float (*b2RestitutionCallback)( float restitutionA, int typeA, float restitutionB, int typeB );
